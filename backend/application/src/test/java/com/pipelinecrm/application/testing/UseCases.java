...
public final class UseCases {
    ...
    public final RenameCompany renameCompany = new RenameCompanyInteractor(companies, parties, writing);
    ...
    public final CorrectContact correctContact = new CorrectContactInteractor(contacts, writing);
